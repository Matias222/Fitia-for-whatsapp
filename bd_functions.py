...
async def insertar_usuario(numero_usuario,nombre="",peso=0.0,talla=0.0):
    ...
    if len(db_item[1]) == 0:
        new_user = {'numero': numero_usuario, 'nombre':nombre,'peso':peso,'talla':talla}
...
async def update_usuario(numero_usuario,nombre="",peso=0.0,talla=0.0):
    new_user = {'nombre':nombre,'peso':peso,'talla':talla}
